...
load_file_from_url(
    url="https://github.com/abdalrahmenyousifMohamed/ML/releases/download/track/Wav2Lip_GAN.pth",
...
load_file_from_url(
    url="https://github.com/abdalrahmenyousifMohamed/ML/releases/download/track/Wav2Lip.pth",
    model_dir="checkpoints",
    progress=True,
...
load_file_from_url(
    url="https://github.com/abdalrahmenyousifMohamed/ML/releases/download/track/GFPGANv1.4.pth",
    model_dir="checkpoints",
    progress=True,
...
load_file_from_url(
    url="https://github.com/abdalrahmenyousifMohamed/ML/releases/download/track/shape_predictor_68_face_landmarks_GTX.dat",
    model_dir="checkpoints",
    progress=True,
